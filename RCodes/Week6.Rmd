...
## Grabbing January 2016 tide heights
```{r GrabJanuary}
Jan = NOAAfunction(9413450, 20160101, 20160131)
```
## Plotting Jan
```{r PlotJanuary}
# Plotting January tide heights
plotTides(Jan)
```

## Grabbing February 2016 tide heights
```{r GrabFebruary}
# Subsetting February tide heights
Feb = NOAAfunction(9413450, 20160201, 20160228)
```
## Plotting Feb
```{r PlotFebruary}
# Plotting February tide heights
plotTides(Feb)
```

## Grabbing March 2016 tide heights
```{r GrabMarch}
# Subsetting March tide heights
Mar = NOAAfunction(9413450, 20160301, 20160331)
```
## Plotting Mar
```{r PlotMarch, cache = TRUE, message = FALSE, warning = FALSE}
# Plotting March tide heights
plotTides(Mar)
```